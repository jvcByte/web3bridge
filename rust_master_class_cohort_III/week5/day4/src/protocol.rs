//! Week 5 · Day 4 — the chat protocol, carried over unchanged from Day 3.
//!
//! Day 3's homework was to keep this module transport-agnostic. That paid off:
//! Day 4 adds broadcasting without touching a line of it. Parsing and framing
//! stay separate from delivery.
//!
//! # Specification
//!
...
//! a parser. Choosing sigils that cannot begin a nickname is what keeps it
//! unambiguous — see `validate_nick`.
...
/// - No control characters, so one client cannot corrupt another client's
///   terminal — an ANSI escape in a nickname is a real attack, not a
///   hypothetical, and today every message you send carries your nick to
